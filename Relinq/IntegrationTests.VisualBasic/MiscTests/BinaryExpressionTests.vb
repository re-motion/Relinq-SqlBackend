...
Namespace MiscTests
  ...
  Public Class BinaryExpressionTests
    ...
    <Test()> _
    Public Sub ShortcutOperators()
      Dim employeesWhoAreAlsoCustomers =
          From customer In DB.Customers()
          Where customer.Phone IsNot Nothing AndAlso (customer.City = "London" OrElse customer.City = "Paris")
          Select customer
    ...
    Public Sub NonShortcutOperators()
      Dim employeesWhoAreAlsoCustomers =
          From customer In DB.Customers()
          Where customer.Phone IsNot Nothing And (customer.City = "London" Or customer.City = "Paris")
          Select customer
