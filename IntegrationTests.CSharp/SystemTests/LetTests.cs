  ...
  public class LetTests : TestBase
  {
    ...
    public void QueryWithSeveralJoinsAndLet ()
    {
      var query =
          ...
          let x = od.Order.Customer
          where x.ContactName == "Liz Nixon"
          select x;
