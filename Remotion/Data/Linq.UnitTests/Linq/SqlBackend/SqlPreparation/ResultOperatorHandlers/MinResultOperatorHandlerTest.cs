...
{
  [TestFixture]
  public class MinResultOperatorHandlerTest
  {
    private ISqlPreparationStage _stage;
    private UniqueIdentifierGenerator _generator;
    private MinResultOperatorHandler _handler;
    ...
    [Test]
    public void HandleResultOperator_MinAfterTopExpression ()
    {
    ...
    [Test]
    public void HandleResultOperator_MinAfterGroupExpression ()
    {
    ...
    [Test]
    public void HandleResultOperator_MinAfterDistinctExpression ()
    {
