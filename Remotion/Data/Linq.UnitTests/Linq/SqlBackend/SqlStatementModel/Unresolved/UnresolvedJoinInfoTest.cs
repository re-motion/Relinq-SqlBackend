...
namespace Remotion.Data.Linq.UnitTests.Linq.SqlBackend.SqlStatementModel.Unresolved
{
  ...
  public class UnresolvedJoinInfoTest
  {
    ...
    public void SetUp ()
    {
      _entityExpression = new SqlEntityDefinitionExpression (typeof (Cook), "c", new SqlColumnDefinitionExpression (typeof (string), "c", "Name", false));
    }
    ...
    {
      _entityExpression = new SqlEntityDefinitionExpression (typeof (Restaurant), "r", new SqlColumnDefinitionExpression (typeof (string), "c", "Name", false));
