...
namespace Remotion.Data.Linq.UnitTests.Linq.SqlBackend.SqlStatementModel
{
  ...
  public class SqlJoinedTableTest
  {
    ...
    {
      var oldEntityExpression = new SqlEntityDefinitionExpression (typeof (Kitchen), "c", new SqlColumnDefinitionExpression (typeof (string), "c", "Name", false));
      ...
      var newEntityExpression = new SqlEntityDefinitionExpression (typeof (Cook), "c", new SqlColumnDefinitionExpression (typeof (string), "c", "Name", false));
