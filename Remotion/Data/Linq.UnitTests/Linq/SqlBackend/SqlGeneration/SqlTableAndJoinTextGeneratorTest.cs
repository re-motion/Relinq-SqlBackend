...
namespace Remotion.Data.Linq.UnitTests.Linq.SqlBackend.SqlGeneration
{
  ...
  public class SqlTableAndJoinTextGeneratorTest
  {
    ...
    public void GenerateSql_ForJoinedTable ()
    {
      ...
      var entityExpression = new SqlEntityExpression (originalTable, new SqlColumnExpression (typeof (string), "c", "Name", false));
    ...
    public void GenerateSql_ForJoinedTable_Recursive ()
    {
      ...
      var entityExpression1 = new SqlEntityExpression (originalTable, new SqlColumnExpression (typeof (string), "c", "Name", false));
      ...
      var entityExpression2 = new SqlEntityExpression (originalTable, new SqlColumnExpression (typeof (string), "c", "Name", false));
