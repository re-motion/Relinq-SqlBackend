...
namespace Remotion.Data.Linq.UnitTests.Linq.Core.Backend.SqlGeneration.SqlServer.MethodCallGenerators
{
  [TestFixture]
  public class MethodCallLowerTest : MethodCalTestBase
  {
    [Test]
    public void ToLower ()
    {
      ...
      methodCallLower.GenerateSql (methodCall, CommandBuilder);

      Assert.AreEqual ("xyz LOWER([s].[FirstColumn])", CommandBuilder.GetCommandText ());
    }
