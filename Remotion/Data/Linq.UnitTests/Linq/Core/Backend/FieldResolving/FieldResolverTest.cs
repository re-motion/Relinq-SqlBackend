...
namespace Remotion.Data.Linq.UnitTests.Linq.Core.Backend.FieldResolving
{
  ...
  public class FieldResolverTest
  {
    ...
    [ExpectedException (typeof (FieldAccessResolveException), ExpectedMessage = 
        "'Remotion.Data.Linq.UnitTests.Linq.Core.TestDomain.Cook.FirstName' is not a relation member.")]
    ...
    [Test]
    [ExpectedException (typeof (FieldAccessResolveException), ExpectedMessage =
        "The member 'Remotion.Data.Linq.UnitTests.Linq.Core.TestDomain.Cook.NonDBStringProperty' does not identify a queryable column.")]
