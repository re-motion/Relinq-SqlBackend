...
namespace Remotion.Data.Linq.UnitTests.Linq.Core.Backend.DetailParsing
{
  [TestFixture]
  public class OrderingFieldParserTest
  {
    ...
    [Test]
    [ExpectedException (typeof (FieldAccessResolveException), ExpectedMessage = "The member 'Remotion.Data.Linq.UnitTests.Linq.Core.TestDomain.Cook.NonDBStringProperty' "
    ...
    [Test]
    [ExpectedException (typeof (NotSupportedException), ExpectedMessage = "Ordering by 'Remotion.Data.Linq.UnitTests.Linq.Core.TestDomain.Kitchen.Cook' "
