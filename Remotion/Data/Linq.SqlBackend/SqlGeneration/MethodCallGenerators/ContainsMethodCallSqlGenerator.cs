...
{
  /// <summary>
  /// <see cref="ContainsMethodCallSqlGenerator"/> implements <see cref="IMethodCallSqlGenerator"/> for the string like and contains method.
  /// </summary>
  public class ContainsMethodCallSqlGenerator : IMethodCallSqlGenerator
  {
