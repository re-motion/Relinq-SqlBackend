...
{
  public class GuidNewGuidMethodCallTransformer : IMethodCallTransformer
  {
    public static readonly MethodInfo[] SupportedMethods =
        new[]
        {
            MethodCallTransformerUtility.GetStaticMethod (typeof (Guid), "NewGuid")
        };
    ...
    public Expression Transform (MethodCallExpression methodCallExpression)
    {
      ...
      return new SqlFunctionExpression (typeof (Guid), "NEWID");
    }
  }
}