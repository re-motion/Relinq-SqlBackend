...
{
    /// <summary>
    /// <see cref="SetOperation"/> modifies <see cref="UnresolvedJoinInfo"/>s and generates <see cref="ResolvedJoinInfo"/>s.
    /// </summary>
    public class SetOperationReconciliationVisitor : RelinqExpressionVisitor,
            IResolvedSqlExpressionVisitor
    {
        ...
        public Expression VisitSqlEntity (SqlEntityExpression expression)
        {
            ...
            return _reconciliationContext.RequiresReconciliation (expression)
