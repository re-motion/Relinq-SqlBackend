...
namespace Remotion.Linq.SqlBackend.UnitTests.MappingResolution
{
  ...
  public class ResolvingExpressionVisitorTest
  {
    ...
    public void VisitTypeBinaryExpression ()
    {
      ...
      _resolverMock.Setup (mock => mock.ResolveConstantExpression (expression))
          .Returns (expression)
          .Verifiable();
      _resolverMock.Setup (mock => mock.ResolveTypeCheck (expression, typeof (Chef)))
          .Returns (resolvedTypeExpression)
          .Verifiable();
      _resolverMock.Setup (mock => mock.ResolveConstantExpression (resolvedTypeExpression))
          .Returns (resolvedRevisitedResult)
          .Verifiable();
    ...
    public void VisitBinaryExpression()
    {
      ...
      _entityIdentityResolverMock
          .Setup (mock => mock.ResolvePotentialEntityComparison (It.Is<BinaryExpression> (e => e.Left == fakeResolvedLeft && e.Right == fakeResolvedRight)))
    ...
    public void VisitUnresolvedCollectionJoinConditionExpression_ObtainsOriginatingEntityAndResolvesConditionAndRevisitsResult ()
    {
      ...
      var fakeResolvedCondition = Expression.Constant (true);
      _resolverMock
          .Setup (mock => mock.ResolveJoinCondition (originatingEntity, unresolvedCollectionJoinTableInfo.MemberInfo, tableInfo))
          .Returns (fakeResolvedCondition)
          .Verifiable();
      var fakeRevisitedExpression = new CustomExpression(typeof(bool));
      _resolverMock
    ...
    public void VisitSqlInExpression_RevisitingTerminatesAfterInnerChanges_WithoutOuterChanges  ()
    {
      ...
      _entityIdentityResolverMock
          ...
          .Returns ((SqlInExpression expression) => expression)
          .Verifiable();
    ...
    public void VisitSqlIsNullExpression_RevisitingTerminatesAfterInnerChanges_WithoutOuterChanges  ()
    {
      ...
      _entityIdentityResolverMock
          ...
          .Returns ((SqlIsNullExpression expression) => expression)
          .Verifiable();
      _compoundComparisonSplitterMock
    ...
    public void VisitSqlIsNotNullExpression_RevisitingTerminatesAfterInnerChanges_WithoutOuterChanges  ()
    {
      ...
      _entityIdentityResolverMock
          ...
          .Returns ((SqlIsNotNullExpression expression) => expression)
          .Verifiable();
      _compoundComparisonSplitterMock
