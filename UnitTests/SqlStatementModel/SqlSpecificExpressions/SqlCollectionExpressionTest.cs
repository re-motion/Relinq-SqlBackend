...
namespace Remotion.Linq.SqlBackend.UnitTests.SqlStatementModel.SqlSpecificExpressions
{
  ...
  public class SqlCollectionExpressionTest
  {
    ...
    public void VisitChildren_SameItems ()
    {
      ...
      visitorMock.Setup (mock => mock.Visit (_collectionExpression.Items[0])).Returns (_collectionExpression.Items[0]).Verifiable();
      visitorMock.Setup (mock => mock.Visit (_collectionExpression.Items[1])).Returns (_collectionExpression.Items[1]).Verifiable();
    ...
    public void VisitChildren_NewItems ()
    {
      ...
      var visitorMock = new Mock<ExpressionVisitor> (MockBehavior.Strict);
      visitorMock.Setup (mock => mock.Visit (_collectionExpression.Items[0])).Returns (newItem).Verifiable();
      visitorMock.Setup (mock => mock.Visit (_collectionExpression.Items[1])).Returns (_collectionExpression.Items[1]).Verifiable();
