  ...
  public class SqlGeneratingExpressionVisitorTest
  {
    ...
    public void GenerateSql_VisitSqlColumnExpression ()
    {
      ...
      SqlGeneratingExpressionVisitor.GenerateSql (
          sqlColumnExpression, _commandBuilder, _stageMock.Object);
    ...
    public void GenerateSql_VisitSqlEntityExpression_EntityReference ()
    {
      ...
      SqlGeneratingExpressionVisitor.GenerateSql (entityExpression, _commandBuilder, _stageMock.Object);
    ...
    public void GenerateSql_BoolExpression_ValueSemantics ()
    {
      ...
      SqlGeneratingExpressionVisitor.GenerateSql (
          boolExpression, _commandBuilder, _stageMock.Object);
    ...
    public void GenerateSql_UnsupportedExpression ()
    {
      ...
      Assert.That (
          () => SqlGeneratingExpressionVisitor.GenerateSql (unknownExpression, _commandBuilder, _stageMock.Object),
    ...
    public void VisitBinaryExpression ()
    {
      ...
      SqlGeneratingExpressionVisitor.GenerateSql (
          binaryExpression, _commandBuilder, _stageMock.Object);
    ...
    public void VisitUnaryExpression_UnaryNot ()
    {
      ...
      SqlGeneratingExpressionVisitor.GenerateSql (
          unaryNotExpression, _commandBuilder, _stageMock.Object);
      var result = _commandBuilder.GetCommandText();
    ...
    public void VisitUnaryExpression_UnaryNot_NullableBool ()
    {
      ...
      SqlGeneratingExpressionVisitor.GenerateSql (unaryNotExpression, _commandBuilder, _stageMock.Object);
      var result = _commandBuilder.GetCommandText ();
    ...
    public void VisitUnaryExpression_NotSupported ()
    {
      ...
      Assert.That (
          () => SqlGeneratingExpressionVisitor.GenerateSql (unaryExpression, _commandBuilder, _stageMock.Object),
          Throws.InstanceOf<NotSupportedException>()
              .With.Message.EqualTo (
    ...
    public void VisitMethodCallExpression_NotSupported ()
    {
      ...
      Assert.That (
          () => SqlGeneratingExpressionVisitor.GenerateSql (methodCallExpression, _commandBuilder, _stageMock.Object),
          Throws.InstanceOf<NotSupportedException>()
              .With.Message.EqualTo (
    ...
    public void VisitSqlSubStatementExpression ()
    {
      ...
      _stageMock
          ...
          .Callback ((ISqlCommandBuilder commandBuilder, SqlStatement _) => commandBuilder.Append ("SELECT [t].[Name] FROM [Table] AS [t]"))
          .Verifiable();
    ...
    public void VisitSqlInExpression ()
    {
      ...
      _stageMock
          .Setup (mock => mock.GenerateTextForSqlStatement (_commandBuilder, It.IsAny<SqlStatement>()))
          .Callback ((ISqlCommandBuilder commandBuilder, SqlStatement _) => commandBuilder.Append ("test"))
          .Verifiable();
    ...
    public void VisitSqlLikeExpression ()
    {
      ...
      SqlGeneratingExpressionVisitor.GenerateSql (sqlInExpression, _commandBuilder, _stageMock.Object);
    ...
    public void VisitSqlIsNullExpression ()
    {
      ...
      SqlGeneratingExpressionVisitor.GenerateSql (
          sqlIsNullExpression, _commandBuilder, _stageMock.Object);
    ...
    public void VisitSqlLiteralExpression_String ()
    {
      ...
      SqlGeneratingExpressionVisitor.GenerateSql (
          expression, _commandBuilder, _stageMock.Object);
    ...
    public void VisitSqlIsNotNullExpression ()
    {
      ...
      SqlGeneratingExpressionVisitor.GenerateSql (
          sqlIsNotNullExpression, _commandBuilder, _stageMock.Object);
    ...
    public void VisitSqlFunctionExpression ()
    {
      ...
      SqlGeneratingExpressionVisitor.GenerateSql (
          sqlFunctionExpression, _commandBuilder, _stageMock.Object);
    ...
    public void VisitSqlConvertExpression ()
    {
      ...
      SqlGeneratingExpressionVisitor.GenerateSql (sqlConvertExpression, _commandBuilder, _stageMock.Object);
    ...
    public void NumberExpression ()
    {
      ...
      _stageMock
          ...
          .Callback ((ISqlCommandBuilder commandBuilder, Ordering ordering) => commandBuilder.Append ("order1 ASC"))
          .Verifiable();
      _stageMock
          .Setup (mock => mock.GenerateTextForOrdering (_commandBuilder, ordering2))
          .Callback ((ISqlCommandBuilder commandBuilder, Ordering ordering) => commandBuilder.Append ("order2 DESC"))
          .Verifiable();
    ...
    public void VisitSqlEntityConstantExpression ()
    {
      ...
      Assert.That (
          () => SqlGeneratingExpressionVisitor.GenerateSql (entityConstant, _commandBuilder, _stageMock.Object),
