...
{
  [TestFixture]
  public class ConcatResultOperatorHandlerTest : ResultOperatorHandlerTestBase
  {
    private ISqlPreparationStage _stage;
    private ConcatResultOperatorHandler _handler;
    ...
    public override void SetUp ()
    {
      ...
      _handler = new ConcatResultOperatorHandler();
    ...
    [Test]
    public void HandleResultOperator_CreatesConcatStatement ()
    {
      ...
      Assert.That (_sqlStatementBuilder.SetOperationCombinedStatements[0].SetOperation, Is.EqualTo (SetOperation.UnionAll));
    }

    private static ConcatResultOperator CreateValidResultOperator ()
    {
      var sqlStatement = SqlStatementModelObjectMother.CreateSqlStatement (Expression.Constant (0));
      return new ConcatResultOperator ("x", typeof (int), new SqlSubStatementExpression (sqlStatement));
    }
  }
}